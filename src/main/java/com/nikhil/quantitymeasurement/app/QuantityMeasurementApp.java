...
import com.nikhil.quantitymeasurement.service.QuantityMeasurementServiceImpl;
import com.nikhil.quantitymeasurement.util.ApplicationConfig;
...
public class QuantityMeasurementApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            logger.info("Are weights equal: ", app.controller.compare(weightInGrams, weightInKilograms));

            QuantityDTO convertedWeight = app.controller.convert(weightInGrams, new QuantityDTO(0, "KILOGRAM", "WEIGHT"));
            ...
            logger.info("Are volumes equal: ", app.controller.compare(volumeInML, volumeInL));
            ...
            logger.info("0 C equals 32 F: ", app.controller.compare(celsius0, fahrenheit32));

            QuantityDTO fahrenheit = app.controller.convert(celsius100, new QuantityDTO(0, "FAHRENHEIT", "TEMPERATURE"));
