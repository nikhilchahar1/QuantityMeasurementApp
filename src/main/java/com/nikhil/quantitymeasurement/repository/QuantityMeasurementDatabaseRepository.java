...
import com.nikhil.quantitymeasurement.exception.DatabaseException;
import com.nikhil.quantitymeasurement.util.ApplicationConfig;
import com.nikhil.quantitymeasurement.util.ConnectionPool;
...
public class QuantityMeasurementDatabaseRepository implements IQuantityMeasurementRepository {
    ...
    private QuantityMeasurementEntity mapRow(ResultSet rs) throws SQLException {
        ...
        QuantityMeasurementEntity entity = new QuantityMeasurementEntity(op1, op2, rs.getString("operation"), res, rs.getString("measurement_type"));
