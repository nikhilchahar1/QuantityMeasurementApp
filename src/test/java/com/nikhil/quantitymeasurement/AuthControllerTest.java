...
import com.nikhil.quantitymeasurement.model.AuthResponse;
import com.nikhil.quantitymeasurement.model.LoginRequest;
import com.nikhil.quantitymeasurement.model.RegisterRequest;
import com.nikhil.quantitymeasurement.controller.AuthController;
import com.nikhil.quantitymeasurement.service.AuthService;
...
class AuthControllerTest {
    ...
    void testRegister_ValidInput_Returns201() throws Exception {
        ...
        RegisterRequest request =
            new RegisterRequest("nikhil", "password123", "nikhil@test.com");
    ...
    void testRegister_EmptyUsername_Returns400() throws Exception {
        RegisterRequest badRequest =
            new RegisterRequest("", "password123", "nikhil@test.com");
    ...
    void testRegister_InvalidEmail_Returns400() throws Exception {
        RegisterRequest badRequest =
            new RegisterRequest("nikhil", "password123", "not-an-email");
    ...
    void testRegister_ShortPassword_Returns400() throws Exception {
        RegisterRequest badRequest =
            new RegisterRequest("nikhil", "abc", "nikhil@test.com");
    ...
    void testLogin_ValidCredentials_Returns200() throws Exception {
        ...
        LoginRequest request = new LoginRequest("nikhil", "password123");
